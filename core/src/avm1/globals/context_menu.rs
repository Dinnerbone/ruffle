...
pub fn constructor<'gc>(
    ...
    let built_in_items = obj_proto.new(activation, obj_proto, &[])?;
    let _ = crate::avm1::globals::object::constructor(activation, built_in_items, &[]);
    ...
    let custom_items = array_proto.new(activation, array_proto, &[])?;
    let _ = crate::avm1::globals::array::constructor(activation, custom_items, &[]);
...
pub fn copy<'gc>(
    ...
    let copy = context_menu_proto.new(activation, context_menu_proto, &[])?;
    let _ = constructor(activation, copy, &[callback.into()]);
