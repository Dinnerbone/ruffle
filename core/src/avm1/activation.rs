...
impl<'a, 'b: 'a, 'gc: 'b, 'gc_context: 'a> Activation<'a, 'b, 'gc, 'gc_context> {
    ...
    fn action_new_method(&mut self) -> Result<FrameControl<'gc>, Error<'gc>> {
        ...
        if let Value::Object(constructor) = constructor {
            ...
            let mut this = prototype.new(self, prototype, &args)?;
            this.set("__constructor__", constructor.into(), self)?;
            this.set_attributes(
                self.context.gc_context,
                Some("__constructor__"),
                Attribute::DontEnum.into(),
            ...
            if self.current_swf_version() < 7 {
                this.set("constructor", constructor.into(), self)?;
                this.set_attributes(
                    self.context.gc_context,
                    Some("constructor"),
                    Attribute::DontEnum.into(),
            ...
            constructor.call("[ctor]", self, this, None, &args)?;
    ...
    pub fn locals_into_request_options<'c>(
        ...
        match method {
            Some(method) => {
                let vars = self.locals_into_form_values();
